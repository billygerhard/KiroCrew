...
describe('ChatPage – sidebar chip reveals a source in the panel', () => {
  ...
  it('the injection is what surfaces it — an unrevealed user-pasted PR stays out', async () => {
    // Bidirectional proof for the first case: with the panel open but NOTHING
